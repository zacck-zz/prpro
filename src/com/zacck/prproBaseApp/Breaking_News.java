...
public class Breaking_News extends ListActivity {
	...
	final class dataGetter extends AsyncTask<Void, Integer, Void> {
		...
		protected void onPreExecute() {
			pd = new ProgressDialog(Breaking_News.this);
		...
		protected Void doInBackground(Void... arg0) {
			...
			try {
				...
				pullComm.setURI(new URI(
						"https://ajax.googleapis.com/ajax/services/search/news?v=1.0&q=scangroup&rsz=8&h1=en&ned=en_ke&scoring=d"));
		...
		protected void onPostExecute(Void result) {
			...
			SimpleAdapter adapter = new SimpleAdapter(Breaking_News.this, commList,
